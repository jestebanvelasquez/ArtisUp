    ...
    return (
        <section className='lg:min-h-[712px] bg-overview bg-cover bg-left-top pt-[30px] lg:pt-[87px]'>
            ...
            <div className='flex items-center pb-10 pt-10 justify-center max-w-sm lg:max-w-full mx-auto lg:mx-0 gap-x-2 lg:gap-x-6' data-aos='fade-down'
                data-aos-delay='400'>
                <Link to={rol === 'USER'? '/user/artists' : rol === 'ARTIST'? : '/user/artists' :  '/signup'} className='text-white btn btn-md p-5 pb-5 lg:btn-lg btn-amber flex items-center justify-center lg:gap-x-4' >
                    {rol ?  ' Descubre Tus Artistas Favoritos' : 'Registrarme' } 
                </Link>
            </div>
